...
extern void wiz_video_flip(int layer);
extern void wiz_video_flip_single(int layer);
//extern void wiz_transp();
...
extern void wiz_sound_init (int rate, int bits, int stereo, int Hz);
extern void wiz_sound_pause (int);
